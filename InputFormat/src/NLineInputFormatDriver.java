//http://stackoverflow.com/questions/26821652/mapreduce-how-to-get-mapper-to-process-multiple-lines
...
import com.impetus.inputformat.NLineInputFormat.MapperNLine;
...
public class NLineInputFormatDriver extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new Configuration(), new NLineInputFormatDriver(), args);
